                        ...
                        const __lazyForEachItemGenFunction = _item => {
                            const item = _item;
                            {
                                ...
                                const observedDeepRender = () => {
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        // 对比图标/按钮
                                        Image.create(this.isInCompareList(item) ? { "id": 16777308, "type": 20000, params: [], "bundleName": "com.example.list_harmony", "moduleName": "entry" } : { "id": 16777309, "type": 20000, params: [], "bundleName": "com.example.list_harmony", "moduleName": "entry" });
                                        // 对比图标/按钮
                                        Image.width(24);
                                        // 对比图标/按钮
                                        Image.height(24);
