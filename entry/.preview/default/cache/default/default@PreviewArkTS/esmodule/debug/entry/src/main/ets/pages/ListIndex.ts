...
class ListIndex extends ViewPU {
    ...
    NavigationTitle(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/ListIndex.ets(37:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/ListIndex.ets(38:7)", "entry");
            Text.fontSize(20);
                ...
                this.ifElseBranchUpdateFunction(0, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                ...
                                }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/ListIndex.ets", line: 69, col: 7 });
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/ListIndex.ets(85:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 主内容区域
            Stack.create();
            Stack.debugLine("entry/src/main/ets/pages/ListIndex.ets(90:7)", "entry");
            // 主内容区域
