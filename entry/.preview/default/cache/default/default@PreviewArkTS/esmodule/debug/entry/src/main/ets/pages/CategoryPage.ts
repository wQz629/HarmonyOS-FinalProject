...
export default class CategoryPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/CategoryPage.ets(89:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 一级分类 Tab（横向）
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/CategoryPage.ets(91:7)", "entry");
            // 一级分类 Tab（横向）
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/CategoryPage.ets(99:9)", "entry");
            // 切换左侧栏显示/隐藏按钮
            Text.fontSize(16);
            // 切换左侧栏显示/隐藏按钮
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 二级分类和商品列表（左右分栏）
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/CategoryPage.ets(113:7)", "entry");
            // 二级分类和商品列表（左右分栏）
            Row.width(LAYOUT_WIDTH_OR_HEIGHT);
            // 二级分类和商品列表（左右分栏）
            Row.layoutWeight(1);
